...
function preload() {
    ...
    // video = createVideo('assets/disco/disco.mp4');
    // video = createVideo('assets/disco/star_laser.mp4');
    // video = createVideo('assets/disco/party_lights_alpha.mp4');
    video = createVideo('assets/disco/party_lights.mp4');
    video.hide();
}
